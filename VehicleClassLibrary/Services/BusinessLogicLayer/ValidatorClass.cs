    ...
    public class ValidatorClass
    {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (string.IsNullOrWhiteSpace(input))
                    {
                        ...
                        throw new ArgumentException("Please enter non empty input");
                    }
                ...
                {
                    Console.WriteLine("Unkown error, please enter valid input");
                }
            }
        }
        ...
        public static decimal GetValidDecimal(string entry)
        {
            ...
            while (true)
            {
                ...
                // Use try catch to check that the input is a valid decimal and not null or empty
                try
                {
                    // Check if the input is null or empty space
                    if (string.IsNullOrWhiteSpace(input))
