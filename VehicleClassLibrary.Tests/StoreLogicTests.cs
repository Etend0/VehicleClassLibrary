...
namespace VehicleClassLibrary.Tests
{
    public class StoreLogicTests
    {
        ...
        {
            // Arrange: Create an instance of StoreLogic (Sytem Under Test - SUT)
            StoreLogic store = new StoreLogic();

            // Create a new CarModel to add to inventory
        ...
        // Test for GetInevntory when no vehicles have been added
        [Fact]
        ...
        [Fact]
        public void AddVehicleToCart_ShouldAddVehicleToCart_WhenValidVehicleIdGiven()
        {
            // Arrange: Create an instance of StoreLogic
            StoreLogic store = new StoreLogic();
        ...
        public void Checkout_ShouldReturnCorrectTotal_AndClearCart()
        {
            ...
            // Create two vehicles and add them to inventory and cart
            ...
            // Assert: Verify that the total is appropriately correct
